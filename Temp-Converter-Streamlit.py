...
choice_to_convert_from = st.number_input("Enter your choice:", min_value=1, max_value=3, step=1)

if choice_to_convert_from == 1:
    temperature = st.number_input("Enter the temperature in Celsius:", step=1.0)
    if st.button("Convert"):
        ...
        choice_to_convert_to = st.number_input("Enter your choice:", min_value=1, max_value=3, step=1)
    ...
    temperature = st.number_input("Enter the temperature in Fahrenheit:", step=1.0)
    if st.button("Convert"):
    ...
    temperature = st.number_input("Enter the temperature in Kelvin:", step=1.0)
    if st.button("Convert"):
